      ...
      <div class="container logindiv">
        ...
        <div class="col-sm-4">
            <form class="text-center" name="loginform" method="post" action="ajax/checklogin.php">
                ...
                <div class="form-group">
                <button name="Submit" id="submit" class="btn btn-lg btn-primary btn-block" data-sitekey="6LdNM9kZAAAAALkLqIW4skR7ZTrL5RG4NDYEsDbu" data-callback='onSubmit' data-action='submit' type="submit">Log In</button>
                </div>
                <div class="form-group">
                    <div class="checkbox">
